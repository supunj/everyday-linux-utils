...
gdrive_sudiv_remote='gdrive_sudiv'
...
gdrive_sudiv_path=$base_folder/$gdrive_sudiv_remote

folder_depth=5

# loop through paths
for search_path in $gdrive_path $onedrive_path $dropbox_path $gdrive_amani_path $gdrive_sudiv_path
do
    ...
    do
            ...
            case $search_path in
              ...
              $gdrive_sudiv_path) storage_service=$gdrive_sudiv_remote ;;
            esac
